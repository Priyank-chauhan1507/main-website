              ...
              >
                ...
                <img src={paymentcenterpic} alt="" />
                  {/* {paymentstatus ? (
                    ...
                    <>
                      <div className="Payleft" style={{ marginRight: "auto" }}>
                        ...
                        {checkPayNow() == true ? (
                          <button className="PayNowBtnActive" onClick={paynow}>
                            {loading ? (
...
export default connect(mapStateToProps, null)(AdmitCard);