...
import "./newmobfooter.css";
import {Link} from "react-router-dom";
import Logo from "../../assests/Logo.png";
import Email from "../../assests/mail1.png";
import Phone from "../../assests/phn1.png";
        ...
        <div className="contact">
          ...
          <div className="mail connect para1">
            <a href="mailto:tech@thomso.in">
              <img src={Email} alt="Mail" className="coblack" />
          ...
          <div className="phone connect para3">
            <a href="tel:+919205915692">
              <img src={Phone} alt="Call" className="coblack"/>
