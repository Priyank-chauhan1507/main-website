        ...
        <div className="comitte-boxs">
            <div
              ...
              <div className={open == "un" ? "mid_info2" : "mid_info1"}>
                <div className="comitee-box-text1">UNITED NATIONS <br />
                GENERAL ASSEMBLY <br />
                &#40; UNGA &#41; </div>
                {open == "un" && (
                  <div className="comitee_boxInfo">
                    Looking at preceding elections, reform attempts have been
                    made in a way that doesn't hurt the basic tenets of
                    democracy and federalism. 'One Election' is a euphemism for
                    simultaneous or synchronized elections in which voters can
                    exercise their separate choices for both Assembly and Lok
                    Sabha polls in one outing. With one or the other election
                    held at regular intervals, all parties remain "election
                    machines" at all times. Many argue that "One nation, one
                    election" is the need of the hour, whereas many stand
                    against it, arguing that it isn't advantageous to any.{" "}
                  </div>
                )}
                {open == "" && (
                  <div
            ...
            >
              ...
              <div className={open == "parliament" ? "mid_info2" : "mid_info1"}>
                <div className="comitee-box-text2">ALL INDIA POLITICAL <br />
                PARTY MEET <br />
                &#40; AIPPM &#41; </div>
                {open == "parliament" && (
                  <div className="comitee_boxInfo">
                    ...
                    China into two Chinas at the "end" of the Chinese Civil War
                    in 1955. The PRC rules only Mainland China and has no
                    control but claims Taiwan as part of its territory under its
                    "One China Principle."The situation has been escalating
                    since late 2019, with military actions and, as of recent,
                    the heavy military demonstration by China after Speaker of
                    the House of the United States, Nancy Pelosi, visited
                    Taiwan. We invite delegations to participate in the UNSC,
                    discuss the actions taken, and try and achieve a compromise.{" "}
                    <p style={{ color: "red" }}>
