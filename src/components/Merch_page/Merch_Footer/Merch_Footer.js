...
import Footer from "./Merch_Footer_Mob";
...
const WebNavbarNew = () => {
  ...
  return (
    <>
      ...
      <a href="https://drive.google.com/file/d/1j3SrUhxlt6JUg3kjpK2mSLe6iy3onzCd/view?usp=drive_link" className="TNC" style={{color:"white"}} target="_blank">
       Terms & Conditions
