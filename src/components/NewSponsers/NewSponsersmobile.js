        ...
        <div className='spons_content'>
         ...
         <div className='spons_box3'>
            <img src={sponsbox} alt=''/>
             <div className='spons_cont3'>
                <div className='spons_heading'>
                <p className=' '>HYDRATION PARTNER</p>
                <p>GOLD PARTNER</p>
                <p>ALUMNI PARTNER</p>
                <p>DIAMOND SPONSOR</p>
         ...
         <div className='spons_box3'>
            ...
            <p>GOLD SPONSOR</p>
                ...
                <img className='brand' src={best} alt=''/>
                    ...
                    <img className=' ' src={line} alt=''/>
                    <img className='brand  ' src={unibic} alt=''/>
                    <img className=' ' src={line} alt=''/>
         ...
         <div className='spons_box3'>
            ...
            <p>MERCHANDISE PARTNER</p>
                <p>MAJOR SPONSOR</p>
                <p>SNACKS PARTNER</p>
                <p className=' '>PLATINUM SPONSOR</p>
                ...
                <img className='brand' src={bonkers} alt=''/>
                    ...
                    <img className=' ' src={line} alt=''/>
                    <img className='brand  ' src={stockdaddy} alt=''/>
         ...
         <div className='spons_box3'>
            ...
            <p>MAJOR SPONSOR</p>
                <p>CO SPONSOR</p>
                <p className=' '>HEALTHY SNACKING PARTNER</p>
         ...
         <div className='spons_box3'>
            ...
            <p>JEWELLRY PARTNER</p>
                ...
                <p className=' '>Mobile accessories Partner</p>
                </div>
                <div className='spons_img2'>
                <img className='brand  ' src={tessco} alt=''/>
                <img src={line} alt=''/>
         ...
         <div className='spons_box3'>
            ...
            <p>ICE POPS PARTNER</p>
                ...
                <img className='brand' src={skippi} alt=''/>
                    <img className=' ' src={line} alt=''/>
                    <img className='brand  ' src={yardley} alt=''/>
                    <img src={line} alt=''/>
         ...
         <div className='spons_box3'>
            ...
            <div className='spons_heading'>
                ...
                <p className=' '>SUPPLY CHAIN PARTNER</p>
                <p>MAJOR SPONSOR</p>
                </div>
                <div className='spons_img2'>
         ...
         <div className='spons_box3'>
            ...
            <div className='spons_heading'>
                ...
                <p>SPORTS PARTNER</p>
                <p>CO SPONSOR</p>
                <p className=''>Skill Development Partner</p>
                </div>
                <div className='spons_img2'>
